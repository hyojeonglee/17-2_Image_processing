...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	for (int i = 0; i<256; i++)
	{
		for (int j = 0; j<256; j++)
		{
			for (int c = 0; c<3; c++)
			{
				x = (-53.9*double(j) + 7.5291*double(i) - 4002.5) / (-0.0063*double(j) + 0.0569*double(i) - 81.6835);
				y = (-0.7606*double(j) + -48.825*double(i) - 1388.6) / (-0.0063*double(j) + 0.0569*double(i) - 81.6835);
